var HeaderVideo = (function ($, document) {
    ...
    var appendTeaserVideo = function() {
        if(Modernizr.video && !isMobile()) {
            var source = videoDetails.teaser,
                html = '<video autoplay="true" loop="false" muted id="teaser-video" class="teaser-video"><source src="'+source+'.mp4" type="video/mp4"><source src="'+source+'.ogv" type="video/ogg"></video>';
    ...
    var createFrame = function() {
        if(videoDetails.provider === 'local') {
            var html = '<iframe src="'+videoDetails.id+'.mp4" &options[autoplay]=true&options[initialTime]=122" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        }
		else if(videoDetails.provider === 'youtube') {
            ...
            var html = '<video autoplay="true" id="video"><source src="'+videoDetails.id+'.mp4" type="video/mp4"><source src="'+videoDetails.id+'.ogv" type="video/ogg"></video>';
        }
        return html;
    };
    ...
    var appendFrame = function() {
		...
		/* Added on end listener */
		$("#video").get(0).onended = function(){
		  $(".video-trigger,.header-video--media").show()
		  $(this).remove()
		}
		/* Added on end listener Ends */
    };
